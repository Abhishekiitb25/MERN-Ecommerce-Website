...
import { ThunkDispatch, Reducer, UnknownAction, Middleware, ThunkAction, ActionCreatorWithPayload, AsyncThunk, SHOULD_AUTOBATCH, Draft, SerializedError, ActionCreatorWithoutPayload, createSelector } from '@reduxjs/toolkit';
...
type PatchQueryDataThunk<Definitions extends EndpointDefinitions, PartialState> = <EndpointName extends QueryKeys<Definitions>>(endpointName: EndpointName, args: QueryArgFrom<Definitions[EndpointName]>, patches: readonly Patch[], updateProvided?: boolean) => ThunkAction<void, PartialState, any, UnknownAction>;
...
declare function buildSlice({ reducerPath, queryThunk, mutationThunk, context: { endpointDefinitions: definitions, apiUid, extractRehydrationInfo, hasRehydrationInfo, }, assertTagType, config, }: {
    reducerPath: string;
...
export { type Api, type ApiContext, type ApiEndpointMutation, type ApiEndpointQuery, type ApiModules, type BaseQueryApi, type BaseQueryEnhancer, type BaseQueryFn, type CombinedState, type CoreModule, type CreateApi, type CreateApiOptions, DefinitionType, type DefinitionsFromApi, type EndpointBuilder, type EndpointDefinition, type EndpointDefinitions, type FetchArgs, type FetchBaseQueryArgs, type FetchBaseQueryError, type FetchBaseQueryMeta, type Module, type MutationActionCreatorResult, type MutationDefinition, type MutationResultSelectorResult, type OverrideResultType, type PrefetchOptions, type QueryActionCreatorResult, type QueryArgFrom, type QueryCacheKey, type QueryDefinition, type QueryKeys, type QueryResultSelectorResult, QueryStatus, type QuerySubState, type ResultTypeFrom, type RootState, type SerializeQueryArgs, type SkipToken, type StartQueryActionCreatorOptions, type SubscriptionOptions, type Id as TSHelpersId, type NoInfer as TSHelpersNoInfer, type Override as TSHelpersOverride, type TagDescription, type TagTypesFromApi, buildCreateApi, copyWithStructuralSharing, coreModule, createApi, defaultSerializeQueryArgs, fakeBaseQuery, fetchBaseQuery, retry, setupListeners };
