import { DynamicMiddlewareInstance, MiddlewareApiConfig, GetState, GetDispatch, TSHelpersExtractDispatchExtensions } from '@reduxjs/toolkit';
...
interface ReactDynamicMiddlewareInstance<State = any, DispatchType extends Dispatch<UnknownAction> = Dispatch<UnknownAction>> extends DynamicMiddlewareInstance<State, DispatchType> {
